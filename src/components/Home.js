...
import StackBarCharts from "./StackedBarCharts";
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading ? (
          ...
          <div>
            ...
            />
            <LineCharts  
              title={`Monthly linechart Created Issues for ${repository.value} in last 2 year`} 
              data={githubRepoData?.created}  
            />  
            <LineCharts 
              title={`Monthly linechart Closed Issues for ${repository.value} in last 2 year`}  
              data={githubRepoData?.closed} 
            />

            <BarCharts  
              title={`Bar Chart of Stars count for every repo in last 2 years`}  
              data={githubRepoData?.starCount}  
            />  
              
            <BarCharts  
              title={`Bar Chart of Fork count for every repo in last 2 years`} 
              data={githubRepoData?.forkCount}  
            />  

            {/* Render stackbarchart component for a monthly created issues for a selected repositories*/}  
            <StackBarCharts 
              title={`Stack-Bar chart of created and Closed Issue for ${repository.value} in last 2year`}  
              data={githubRepoData?.created}  
